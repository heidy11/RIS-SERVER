/**
 * Pruebas del mapeador RisOrder -> DICOM MWL.
 *
 * Usan el runner nativo de Node (node:test), sin agregar dependencias:
 *   yarn test
 *
 * Cubren los modos de falla que el documento de integracion marca como los mas
 * frecuentes y mas dificiles de diagnosticar en campo, porque no producen
 * ningun error visible: el POST devuelve 200 y el equipo simplemente no
 * muestra al paciente.
 */

// La configuracion se lee al importar el modulo, asi que el entorno se fija antes.
